...
System.register("chunks:///_virtual/paused-popup-sg.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './bridge-util.ts', './audio-manager.ts', './ui-manager.ts', './ui-view.ts', './game-constants.ts', './btn-toggle.ts', './ui-config.ts', './reward-manager.ts', './config.ts', './time-agent.ts', './game-data-manager.ts', './game-data-type-define.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Node, _decorator, Label, director, BridgeUtil, VibrationEffect, AudioManager, UIManager, UIView, AudioUrl, GameEvent, ParamStage, BtnToggle, UIID, RewardManager, Config, TimeAgent, GameDataManager, SgState;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      let PausedPopupSg = exports('PausedPopupSg', (_dec = ccclass('PausedPopupSg'), _dec2 = property(BtnToggle), _dec3 = property(BtnToggle), _dec4 = property(BtnToggle), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class PausedPopupSg extends UIView {
        constructor(...args) {
          super(...args);
        ...
        onContactBtn() {
          ...
          let title = `【${Config.GAME_CODE}】` + date;
          let content = `Thank you for contacting us! We would appreciate it if you could share more details regarding your issue or inquiry below.\nApp Version:${Config.GAME_VERSION}`;
...
System.register("chunks:///_virtual/picture-obtain-popup.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './bridge-util.ts', './audio-manager.ts', './ui-manager.ts', './ui-view.ts', './ui-config.ts', './game-constants.ts', './game-data-manager.ts', './sg-type-define.ts', './sg-manager.ts', './report-agent.ts', './log-util.ts', './reward-manager.ts', './bg-adapter.ts', './ad-manager.ts', './graph-manager.ts', './loading-manager.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "2f132DGut9DPrWczg4D6Zfx", "picture-obtain-popup", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let PictureObtainPopup = exports('PictureObtainPopup', (_dec = ccclass('PictureObtainPopup'), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec8 = property(Node), _dec9 = property(Sprite), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Sprite), _dec13 = property(Node), _dec14 = property({
        ...
        async onOpen(fromUI, ...args) {
          ...
          if (sprB) {
            ...
            ReportAgent.reportPageMonitoring(PageName.PictureObtainPopup, false);
          } else {
            this.sprPicPrivate.node.active = false;
            this.sprMagPrivate.node.active = false;
            ReportAgent.reportPageMonitoring(PageName.PictureObtainPopup, true);
          }
        }
        onSwitchBtn() {
          this.flipPicture();
          ...
          AdManager.instance.openVideoAd('slide-picture-download', (entry, success) => {
            if (success) {
              if (this.sprPicCover.node.active) {
                ...
                let taskInfo = new LoadingTaskReportInfo(this.picInfo.id, LoadingTaskType.DOWNLOAD, LoadingTaskState.START, Date.now(), null, GameDataManager.instance.data.level);
    ...
    execute: function () {
      ...
      let PictureSelectView = exports('PictureSelectView', (_dec = ccclass('PictureSelectView'), _dec2 = property([PictureSelectItem]), _dec3 = property(Node), _dec(_class = (_class2 = class PictureSelectView extends UIView {
        ...
        onOpen(fromUI, ...args) {
          ...
          ReportAgent.reportPageMonitoring(PageName.PictureSelectView, isPageShowError);
          if (showItemCount < 1) {
...
System.register("chunks:///_virtual/slide-picture-view.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ui-manager.ts', './ui-view.ts', './sg-manager.ts', './game-data-manager.ts', './sg-type-define.ts', './ui-config.ts', './bridge-util.ts', './report-agent.ts', './reward-manager.ts', './audio-manager.ts', './game-constants.ts', './ui-util.ts', './bg-adapter.ts', './graph-manager.ts', './ad-manager.ts', './loading-manager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Node, Sprite, ProgressBar, Mask, Label, SpriteFrame, _decorator, sys, UITransform, Vec3, Rect, ParticleSystem2D, Graphics, Vec2, director, UIOpacity, tween, UIManager, UIView, SgManager, GameDataManager, PictureType, UIID, BridgeUtil, ReportAgent, CustomReportEvent, PageName, BtnName, PhotoChooseNumReportEvent, RewardManager, AudioManager, AudioUrl, UIUtil, BgAdapter, GraphManager, AdManager, LoadingManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      let SlidePictureView = exports('SlidePictureView', (_dec = ccclass('SlidePictureView'), _dec2 = property([Node]), _dec3 = property(Node), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(ProgressBar), _dec7 = property(Mask), _dec8 = property(Mask), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Sprite), _dec14 = property(Sprite), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Sprite), _dec21 = property({
        type: [SpriteFrame]
      }), _dec22 = property(Node), _dec23 = property(Node), _dec24 = property(Node), _dec25 = property(Node), _dec(_class = (_class2 = class SlidePictureView extends UIView {
        constructor(...args) {
          super(...args);
        ...
        async onOpen(fromUI, ...args) {
          ...
          this.btnDownload.active = sys.platform != sys.Platform.ANDROID;
          // page action report
          ...
          if (this.layers[0].active) {
            if (this.fromUI === UIID.SpecialRewardPopup) {
              ReportAgent.reportPageMonitoring(PageName.SlidePictureViewSpeical, isPageShowError);
            } else {
              ReportAgent.reportPageMonitoring(PageName.SlidePictureView, isPageShowError);
            }
          } else {
            ReportAgent.reportPageMonitoring(PageName.DownLoadPage, isPageShowError);
          }
        }
        onClose() {
      ...
      let SpecialRewardPopup = exports('SpecialRewardPopup', (_dec = ccclass('SpecialRewardPopup'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Node), _dec8 = property(Sprite), _dec9 = property(Sprite), _dec10 = property({
        ...
        async onOpen(fromUI, ...args) {
          ...
          if (sprB) {
            ...
            ReportAgent.reportPageMonitoring(PageName.SpecialRewardPopup, false);
          } else {
            this.sprPicPrivate.node.active = false;
            this.sprMagPrivate.node.active = false;
            ReportAgent.reportPageMonitoring(PageName.SpecialRewardPopup, true);
          }
        }
        onSwitchBtn() {
          this.flipPicture();
